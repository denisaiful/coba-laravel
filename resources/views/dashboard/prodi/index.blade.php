...
<a href="/dashboard/prodi/create" class="shadow p-2 rounded btn btn-success mb-3">Tambah Program Studi</a>
        ...
        <table id="example" class="ui celled table" >
          ...
          @foreach($prodies as $prodi)
            <tr>
              ...
              <td>
              <a href="/dashboard/prodi/{{ $prodi->id }}/edit" class="badge bg-warning"> <span data-feather="edit"></span></a>
